...
async def shutdown_bot(event):
    ...
    await edit_or_reply(event, "**Kyura-Userbot Berhasil di matikan Todd!**")
...
async def reedme(event):
    await edit_or_reply(
        ...
        "\n✣ [Userbot Repo](https://github.com/Kyuraxp/Kyura-Userbot/blob/Man-Userbot/README.md)"
        "\n✣ [Video Tutorial](https://youtu.be/tTDaPKsGC1I)"
        "\n✣ [List Variabel Heroku untuk Kyura-Userbot](https://telegra.ph/List-Variabel-Heroku-untuk-Man-Userbot-09-22)"
...
async def repo_is_here(event):
    ...
    await xx.edit(
        f"**Hai**, __Saya menggunakan__ 🗿 **Kyura-Userbot** 🗿\n\n"
        ...
        f"✣ **Repo :** [Kyura-Userbot](https://github.com/mrismanaziz/Man-Userbot)\n"
    )
